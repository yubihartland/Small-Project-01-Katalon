...
WebUI.setText(findTestObject('Credit_Card_Number/Card_Number'), findTestData('Credit_card').getValue(3, 2))

WebUI.setText(findTestObject('Credit_Card_Number/Expired_Date'), findTestData('Credit_card').getValue(4, 2))

WebUI.setText(findTestObject('Credit_Card_Number/CVV'), findTestData('Credit_card').getValue(5, 2))

WebUI.click(findTestObject('Potongan_Promo/Potongan_10_rupiah'))

WebUI.click(findTestObject('Credit_Debit_Card/Pay_now_button'))

WebUI.setText(findTestObject('Credit_Card_Number/Bank_OTP'), findTestData('Credit_card').getValue(6, 2))

WebUI.click(findTestObject('Credit_Card_Number/Ok_button'))

WebUI.click(findTestObject('Credit_Card_Number/Transaction_failed'), FailureHandling.STOP_ON_FAILURE)
