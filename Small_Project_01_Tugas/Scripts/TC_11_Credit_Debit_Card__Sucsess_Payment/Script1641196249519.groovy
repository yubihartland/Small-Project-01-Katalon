...
WebUI.setText(findTestObject('Credit_Card_Number/Bank_OTP'), findTestData('Credit_card').getValue(6, 1))

WebUI.click(findTestObject('Credit_Card_Number/Ok_button'))

WebUI.verifyElementPresent(findTestObject('Credit_Card_Number/Verify_thankyou_Succses'), 0)
